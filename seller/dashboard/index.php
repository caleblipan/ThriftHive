    ...
    <body>
        ...
        <div class="row">
            <div class="col-12 jumbotron row">
                <div class="col-7">
                <h1>START CREATING A SHOP</h1>
                <a href="create-shop"><button><i class="fa fa-arrow-right"></i>CREATE A SHOP NOW</button></a>
                </div>
            </div>
            <div class="col-12 wrapper">
                ...
                <div class="row">
                            <?php
                                ...
                                $sql ="SELECT * FROM Shops WHERE sellerID = ".$_SESSION["userID"];
