...
if(isset($_POST['register'])) {
    ...
    if(empty($email) || empty($username) || empty($password)) {
        ...
        $sql ="INSERT INTO Buyers (email, username, password) VALUES (?, ?, ?)"; // Use '?' to avoid SQL injection
        ...
        $sql ="SELECT userID FROM Buyers WHERE username = ?"; // Use '?' to avoid SQL injection
        $stmt = mysqli_prepare($con, $sql);
